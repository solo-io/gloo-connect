...
import (
	...
	"github.com/solo-io/gloo-connect/pkg/gloo/control-plane/bootstrap"
	"github.com/solo-io/gloo-connect/pkg/gloo/control-plane/configwatcher"
	"github.com/solo-io/gloo-connect/pkg/gloo/control-plane/endpointswatcher"
	"github.com/solo-io/gloo-connect/pkg/gloo/control-plane/filewatcher"
	"github.com/solo-io/gloo-connect/pkg/gloo/control-plane/reporter"
	"github.com/solo-io/gloo-connect/pkg/gloo/control-plane/snapshot"
	"github.com/solo-io/gloo-connect/pkg/gloo/control-plane/translator"
	"github.com/solo-io/gloo-connect/pkg/gloo/control-plane/xds"
...
func Setup(store storage.Interface, secrets dependencies.SecretStorage, opts bootstrap.Options, xdsPort int) (*eventLoop, error) {
